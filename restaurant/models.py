...
class Restaurant(models.Model):
    ...
    no = models.FloatField(max_length=100, verbose_name="id", null=True, blank=True)
    ...
    price1 = models.CharField(max_length=10, verbose_name="대표메뉴1 가격", blank=True)
    menu2 = models.CharField(max_length=20, verbose_name="대표메뉴2", blank=True)
    price2 = models.CharField(max_length=10, verbose_name="대표메뉴2 가격", blank=True)
    ...
    tues_breaktime2 = models.CharField(max_length=20, verbose_name="화요일 브레이크타임", null=True, blank=True)
    ...
    imgfile_3 = models.ImageField(null=True, upload_to="", blank=True, verbose_name="이미지3")
